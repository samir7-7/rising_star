...
export default function CroatiaWorkPermit() {
  const openWhatsApp = () => {
    const phoneNumber = "351920448876";
    const message = "Hello! I'm interested in work permit services for Croatia. Can you help me with more information?";
  ...
  const requiredDocuments = [
    ...
    "Croatian language proficiency certificate (if required)",
    ...
    <main className="min-h-screen bg-gray-50">
      ...
      <section className="relative h-64 md:h-80 bg-gray-800 overflow-hidden">
        ...
        <div className="relative z-10 container-responsive h-full flex items-center justify-center">
          ...
          >
            <h1 className="text-3xl md:text-5xl font-bold mb-4">Work Permit in Croatia</h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                Croatia offers a perfect blend of professional opportunities, cultural richness, 
        ...
        <div className="container-responsive">
          ...
          >
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Croatia offers various work permit options depending on your qualifications, 
      ...
      <section className="py-20 bg-white">
        <div className="container-responsive">
          ...
          >
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Croatia has a strong demand for skilled professionals in various sectors.
            </p>
          </motion.div>
