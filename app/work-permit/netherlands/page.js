...
export default function NetherlandsWorkPermit() {
  const openWhatsApp = () => {
    ...
    const message = "Hello! I'm interested in work permit services for Netherlands. Can you help me with more information?";
  ...
  const workPermits = [
    {
      ...
      description: "For professionals with job offer and high salary",
      requirements: ["Job offer from recognized sponsor", "Minimum salary threshold", "Valid passport"],
      duration: "5 years (renewable)"
    },
    {
      title: "Work Visa",
      description: "For employees with job offer from Dutch company",
      requirements: ["Job offer from Dutch employer", "Work permit application", "Health insurance"],
      duration: "1-3 years"
    },
    {
      title: "Startup Visa",
      description: "For innovative entrepreneurs",
      requirements: ["Innovative business plan", "Financial proof", "Mentor agreement"],
  ...
  const requiredDocuments = [
    ...
    "Job offer letter from Dutch employer",
    ...
    "Accommodation proof in Netherlands"
  ];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-center">
            ...
            >
              <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-gray-800 mb-4 md:mb-6">
                Why Choose Netherlands for Work?
              </h2>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-6">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-800 text-sm md:text-base">English Speaking</h3>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-800 text-sm md:text-base">Central Europe</h3>
                    <p className="text-xs md:text-sm text-gray-600">Easy travel access</p>
                  </div>
                </div>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="space-y-3 md:space-y-4">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-sm md:text-base">Population: 17+ million</span>
                </div>
                <div className="flex items-center gap-3">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-sm md:text-base">Official Language: Dutch</span>
                </div>
                <div className="flex items-center gap-3">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-sm md:text-base">Capital: Amsterdam</span>
                </div>
              </div>
            </motion.div>
          </div>
        ...
        <div className="container-responsive">
          ...
          >
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              The Netherlands offers various work permit options depending on your qualifications, 
      ...
      <section className="py-20 bg-white">
        <div className="container-responsive">
          ...
          >
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              The Netherlands has a strong demand for skilled professionals in various sectors.
            </p>
          </motion.div>
